...
class App(ctk.CTk):
    ...
    def __init__(self):
        ...
        central_frame.grid(row=0, column=1, rowspan=3, columnspan=2, padx=0, pady=0, sticky="e")

        # inserting the image
        self.canvas= Canvas(central_frame, width= 850, height= 650)
        ...
        left_frame =  ctk.CTkFrame(self, width=100, height=200, corner_radius=0)
        left_frame.grid(row=0, column=0, rowspan=3, columnspan=2, sticky="nsw")
        left_frame.grid_rowconfigure((1,2,3,4,5), weight=0)

        bottom_frame =  ctk.CTkFrame(self, width=1000, height=10,  corner_radius=0)
        bottom_frame.grid(row=3, column=0, rowspan=3, columnspan=3, sticky="e")
        bottom_frame.grid_columnconfigure((1,2,3,4), weight=0)

        self.btn_scenarioD = ctk.CTkButton(left_frame, text="default", command=button_scenarioD)
        self.btn_scenario1 = ctk.CTkButton(left_frame, text="scenario1", command=button_scenario1)
        self.btn_scenario2 = ctk.CTkButton(left_frame, text="scenario2", command=button_scenario2)
        self.btn_scenario3 = ctk.CTkButton(left_frame, text="scenario3", command=button_scenario3)
        self.btn_scenario4 = ctk.CTkButton(left_frame, text="scenario4", command=button_scenario4)

        self.btn_scenarioD.grid(row=1, column=0, padx=0, pady=40)
        self.btn_scenario1.grid(row=2, column=0, padx=0, pady=40)
        self.btn_scenario2.grid(row=3, column=0, padx=0, pady=40)
        self.btn_scenario3.grid(row=4, column=0, padx=0, pady=40)
        self.btn_scenario4.grid(row=5, column=0, padx=0, pady=40)
        ...
        self.sub_button1.grid(row=0, column=0, padx=10, pady=10)
        self.sub_button2.grid(row=0, column=1, padx=10, pady=10)
        self.sub_button3.grid(row=0, column=2, padx=10, pady=10)
        self.sub_button4.grid(row=0, column=3, padx=10, pady=10)
...
def button_scenario1():
    ...
    clear_lines()
    enable_side_btn()
    app.btn_scenario1.configure(state= DISABLED)
    ## SCENARIO 1
    if DEBUG != True:
...
def button_scenario2():
    ...
    clear_lines()
    enable_side_btn()
    app.btn_scenario2.configure(state= DISABLED)
    ## SCENARIO 2 
    if DEBUG != True:
...
def button_scenario3():
    ...
    enable_bottom_btn()
    enable_side_btn()
    app.btn_scenario3.configure(state= DISABLED)
...
def button_scenario4():
    ...
    clear_lines()
    enable_side_btn()
    app.btn_scenario4.configure(state= DISABLED)
    ## SCENARIO 4
    if DEBUG != True:
...
def enable_side_btn():
    app.btn_scenarioD.configure(state= ACTIVE)
    app.btn_scenario1.configure(state= ACTIVE)
    app.btn_scenario2.configure(state= ACTIVE)
    app.btn_scenario3.configure(state= ACTIVE)
    app.btn_scenario4.configure(state= ACTIVE)
