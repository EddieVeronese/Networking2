...
--id=@1q create queue other-config:min-rate=1000000 other-config:max-rate=70000000 -- \
--id=@2q create queue other-config:min-rate=1000000 other-config:max-rate=70000000 -- \
--id=@3q create queue other-config:min-rate=1000000 other-config:max-rate=30000000 -- \
--id=@4q create queue other-config:min-rate=1000000 other-config:max-rate=30000000
...
--id=@1q create queue other-config:min-rate=1000000 other-config:max-rate=70000000 -- \
--id=@2q create queue other-config:min-rate=1000000 other-config:max-rate=30000000
...
# Creating links
printf "\n[INFO] Creating links scenario 2..."
